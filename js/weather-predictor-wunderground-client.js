$(function() {
  ...
  var wuApiKey = 'daea4dbf8e2953aa'//'<Your API Key>';
  ...
  //Store entered value for later sessions in a cookie.
  ...
  if ($.cookie('location') && $.cookie('location_text')) {
    ...
    var location = '/q/zmw:00000.16.43021';
  }
  ...
  //click event for pop down autocompetion list
